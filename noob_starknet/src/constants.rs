...
lazy_static! {
    ...
    pub static ref UDC_CONTRACT: ContractClass = get_contract_class(include_str!("./compiled/erc20.json"));

    pub static ref DEFAULT_ACCOUNT_CONTRACT: ContractClass = get_contract_class(include_str!("./compiled/account.json"));
